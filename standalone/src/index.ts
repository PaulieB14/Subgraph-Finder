...
app.listen(port, () => {
  ...
  console.log(`Using Graph Hosted Service URL: ${process.env.GRAPH_HOSTED_SERVICE_URL}`);
  console.log(`Using Graph Network Subgraph URL: ${process.env.GRAPH_NETWORK_SUBGRAPH_URL}`);
});
